    ...
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:32px;gap:36px;animation:fadeIn 0.4s ease;">
      ...
      <div style="width:100%;max-width:320px;display:flex;flex-direction:column;gap:20px;">
        <div style="background:#1a1a2e;border:1px solid #2a2a45;border-radius:16px;padding:20px;text-align:center;">
          ...
          <button id="btn-google-login" data-testid="button-google-login" style="display:flex;align-items:center;justify-content:center;gap:12px;width:100%;padding:12px 20px;background:#fff;color:#1f1f1f;border:none;border-radius:10px;font-size:15px;font-weight:600;cursor:pointer;box-shadow:0 2px 8px rgba(0,0,0,0.3);margin-bottom:14px;">
          ...
          <button id="btn-email-login" data-testid="button-email-login" style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:12px 20px;background:transparent;color:#c8c8e0;border:1px solid #2a2a45;border-radius:10px;font-size:15px;font-weight:600;cursor:pointer;font-family:inherit;">
...
function showEmailForm() {
  ...
  render(`
    <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;padding:32px;gap:24px;animation:fadeIn 0.3s ease;">
      ...
      <form id="email-register-form" style="width:100%;max-width:320px;display:flex;flex-direction:column;gap:14px;">
      ...
      <button id="btn-back-to-login" data-testid="button-back-to-login" style="background:transparent;border:none;color:#6c63ff;cursor:pointer;font-size:14px;font-weight:600;font-family:inherit;padding:8px;">
        ← Volver
      </button>
    </div>
  `);

  var form = document.getElementById("email-register-form");
  if (form) {
    form.addEventListener("submit", function(e) { submitEmailForm(e); });
  }
  var btnBack = document.getElementById("btn-back-to-login");
  if (btnBack) {
    btnBack.addEventListener("click", function() { renderLogin(); });
  }
