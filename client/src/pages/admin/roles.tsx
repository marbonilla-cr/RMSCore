...
const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    icon: ShoppingCart,
    keys: ["POS_VIEW", "POS_PAY", "POS_SPLIT", "POS_PRINT", "POS_EMAIL_TICKET", "POS_EDIT_CUSTOMER_PREPAY", "POS_EDIT_CUSTOMER_POSTPAY", "POS_VOID", "POS_VOID_ORDER", "POS_REOPEN", "POS_VIEW_CASH_REPORT"],
  },
  {
    label: "Caja",
    icon: Vault,
